...
# Defaults to full string，好比 ${parameter:-default}。
# However . . .
...
# 使用括弧或空白跳脫 position parameter。

# Thank you, Dan Jacobson, for pointing this out.
# 感謝 Dan Jacobson 指出這一點。
```
...
>`position 跟 length arguments 可以被 parameterized，也就是說，被當作是 variable，而非 numerical constant。`

Example 10-2. Generating an 8-character "random" string
>`範例 10-2。產生有 8-character 的隨機字串。`

```bash
#!/bin/bash
# rand-string.sh
# Generating an 8-character "random" string.
# 產生有 8-character 的隨機字串。
